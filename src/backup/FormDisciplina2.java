 ...
 * @author stefa
 */
public class FormDisciplina2 extends javax.swing.JFrame {

    private ArrayList<Disciplina> disciplina;
    
    public FormDisciplina2() {
       initComponents();
      
    }
    public FormDisciplina2(ArrayList disciplinas) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormDisciplina2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormDisciplina2().setVisible(true);
            }
        });
    }
